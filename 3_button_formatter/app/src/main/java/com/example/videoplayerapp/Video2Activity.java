...
public class Video2Activity extends AppCompatActivity {
    ...
    private Button btnVideo1, btnVideo3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize buttons
        btnVideo1 = findViewById(R.id.btnMain);
        ...
        btnVideo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Video2Activity.this, MainActivity.class));
                finish();
            }
        });
        ...
        String videoPath1 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_2;
        String videoPath2 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath3 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath4 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath5 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath6 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath7 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath8 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath9 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
        String videoPath10 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_1;
        String videoPath11 = "android.resource://" + getPackageName() + "/" + R.raw.love_leon_the_artist;
