    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVideo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Video3Activity.this, MainActivity.class));
                finish();
            }
        });
        ...
        btnVideo3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Video3Activity.this, Video3Activity.class));
                finish();
            }
        });
        ...
        String videoPath1 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
        String videoPath2 = "android.resource://" + getPackageName() + "/" + R.raw.money;
        String videoPath3 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
        String videoPath4 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
        String videoPath5 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
        String videoPath6 = "android.resource://" + getPackageName() + "/" + R.raw.money;
        String videoPath7 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
        String videoPath8 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
        String videoPath9 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
        String videoPath10 = "android.resource://" + getPackageName() + "/" + R.raw.money;
        String videoPath11 = "android.resource://" + getPackageName() + "/" + R.raw.money_r;
