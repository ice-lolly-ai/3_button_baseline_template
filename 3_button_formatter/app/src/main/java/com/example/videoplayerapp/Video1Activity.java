    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVideo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Video1Activity.this, MainActivity.class));
                finish();
            }
        });
        ...
        String videoPath2 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_1;
        String videoPath3 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_2;
        String videoPath4 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_1;
        String videoPath5 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_2;
        String videoPath6 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_2;
        String videoPath7 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_2;
        String videoPath8 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_2;
        String videoPath9 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_1;
        String videoPath10 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_1;
        String videoPath11 = "android.resource://" + getPackageName() + "/" + R.raw.jap_girls_1;
